...
ax2 = ax1.twinx()
ax2.plot(df_messages['Timestamp'], df_messages['PublishLatencyValueAtPercentile50 (ms)'], label='50th Percentile', color='#9CBEC4', alpha=0.5, zorder=1)
ax2.plot(df_messages['Timestamp'], df_messages['PublishLatencyValueAtPercentile75 (ms)'], label='75th Percentile', color='#F2C879', alpha=0.5, zorder=1)
ax2.plot(df_messages['Timestamp'], df_messages['PublishLatencyValueAtPercentile95 (ms)'], label='95th Percentile', color='#8A2A23', alpha=0.5, zorder=1)
ax2.plot(df_messages['Timestamp'], df_messages['PublishLatencyValueAtPercentile99 (ms)'], label='99th Percentile', color='#D9C5B4', alpha=0.5, zorder=1)
...
ax1.set_ylim(0, 1)
ax1.set_yticks([])
ax1.set_title('RabbitMQ Nodes Downtime and Publish Latency Over Time')
